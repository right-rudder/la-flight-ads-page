...
export const LOGO_PRIMARY = "/logo-full.webp";
export const LOGO_SECONDARY = "/logo-full-white.webp";
...
export const ADDRESS = "7900 Balboa Blvd., Unit G6";
export const ADDRESS_CITY = "Van Nuys";
export const ADDRESS_STATE = "California";
export const ADDRESS_ZIP = "91406";
